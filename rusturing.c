...
extern inline int rust_io_uring_opcode_supported(struct io_uring_probe *p,
                                                 int op) {
...
extern inline void rust_io_uring_cqe_seen(struct io_uring *ring,
                                          struct io_uring_cqe *cqe) {
  io_uring_cqe_seen(ring, cqe);
}

extern inline void rust_io_uring_sqe_set_data(struct io_uring_sqe *sqe,
                                              void *data) {
...
extern inline void rust_io_uring_sqe_set_data64(struct io_uring_sqe *sqe,
                                                __u64 data) {
  io_uring_sqe_set_data64(sqe, data);
}

extern inline __u64 rust_io_uring_cqe_get_data64(struct io_uring_cqe *cqe) {
  return io_uring_cqe_get_data64(cqe);
}

extern inline void rust_io_uring_sqe_set_flags(struct io_uring_sqe *sqe,
                                               unsigned flags) {
  io_uring_sqe_set_flags(sqe, flags);
}

extern inline void rust_io_uring_prep_rw(int op, struct io_uring_sqe *sqe,
...
extern inline void rust_io_uring_prep_tee(struct io_uring_sqe *sqe, int fd_in,
...
extern inline void rust_io_uring_prep_readv2(struct io_uring_sqe *sqe, int fd,
                                             const struct iovec *iovecs,
...
extern inline void rust_io_uring_prep_writev2(struct io_uring_sqe *sqe, int fd,
                                              const struct iovec *iovecs,
                                              unsigned nr_vecs, __u64 offset,
                                              int flags) {
...
extern inline void rust_io_uring_prep_recvmsg(struct io_uring_sqe *sqe, int fd,
                                              struct msghdr *msg,
                                              unsigned flags) {
  io_uring_prep_recvmsg(sqe, fd, msg, flags);
}

extern inline void rust_io_uring_prep_sendmsg(struct io_uring_sqe *sqe, int fd,
...
extern inline void rust_io_uring_prep_poll_update(struct io_uring_sqe *sqe,
                                                  __u64 old_user_data,
                                                  __u64 new_user_data,
                                                  unsigned poll_mask,
                                                  unsigned flags) {
  io_uring_prep_poll_update(sqe, old_user_data, new_user_data, poll_mask,
                            flags);
}
...
extern inline void rust_io_uring_prep_accept(struct io_uring_sqe *sqe, int fd,
...
extern inline void
rust_io_uring_prep_accept_direct(struct io_uring_sqe *sqe, int fd,
                                 struct sockaddr *addr, socklen_t *addrlen,
                                 int flags, unsigned file_index) {
...
extern inline void rust_io_uring_prep_connect(struct io_uring_sqe *sqe, int fd,
                                              struct sockaddr *addr,
                                              socklen_t addrlen) {
...
extern inline void rust_io_uring_prep_fallocate(struct io_uring_sqe *sqe,
                                                int fd, int mode, off_t offset,
                                                off_t len) {
  io_uring_prep_fallocate(sqe, fd, mode, offset, len);
}

extern inline void rust_io_uring_prep_openat(struct io_uring_sqe *sqe, int dfd,
                                             const char *path, int flags,
                                             mode_t mode) {
  io_uring_prep_openat(sqe, dfd, path, flags, mode);
}

extern inline void rust_io_uring_prep_openat_direct(struct io_uring_sqe *sqe,
...
extern inline void rust_io_uring_prep_close_direct(struct io_uring_sqe *sqe,
                                                   int file_index) {
...
extern inline void rust_io_uring_prep_statx(struct io_uring_sqe *sqe, int dfd,
                                            const char *path, int flags,
                                            unsigned mask,
...
extern inline void rust_io_uring_prep_madvise(struct io_uring_sqe *sqe,
                                              void *addr, off_t length,
                                              int advice) {
...
extern inline void rust_io_uring_prep_openat2_direct(struct io_uring_sqe *sqe, int dfd,
                                              const char *path,
                                              struct open_how *how,
                                              unsigned file_index) {
...
extern inline void rust_io_uring_prep_epoll_ctl(struct io_uring_sqe *sqe,
                                                int epfd, int fd, int op,
...
extern inline void rust_io_uring_prep_unlinkat(struct io_uring_sqe *sqe,
                                               int dfd, const char *path,
                                               int flags) {
  io_uring_prep_unlinkat(sqe, dfd, path, flags);
}

extern inline void rust_io_uring_prep_renameat(struct io_uring_sqe *sqe,
...
extern inline void rust_io_uring_prep_sync_file_range(struct io_uring_sqe *sqe,
                                                      int fd, unsigned len,
                                                      __u64 offset, int flags) {
  io_uring_prep_sync_file_range(sqe, fd, len, offset, flags);
}

extern inline void rust_io_uring_prep_mkdirat(struct io_uring_sqe *sqe, int dfd,
                                              const char *path, mode_t mode) {
  io_uring_prep_mkdirat(sqe, dfd, path, mode);
}

extern inline void rust_io_uring_prep_symlinkat(struct io_uring_sqe *sqe,
                                           const char *target, int newdirfd,
                                           const char *linkpath) {
  io_uring_prep_symlinkat(sqe, target, newdirfd, linkpath);
}

extern inline void rust_io_uring_prep_linkat(struct io_uring_sqe *sqe, int olddfd,
...
extern inline int rust_io_uring_sqring_wait(struct io_uring *ring) {
...
extern inline int rust_io_uring_cq_eventfd_toggle(struct io_uring *ring,
                                                  bool enabled) {
