...
pub struct io_uring_sqe {
    ...
    pub buf_index: buf_index_group,
    pub personality: libc::__u16,
    pub splice_fd_in_file_index_addr_len: splice_fd_in_file_index_addr_len,
    pub addr3_cmd: addr3_cmd,
}
...
#[repr(C)]
#[repr(packed)]
pub union buf_index_group {
    pub buf_index: libc::__u16,
    pub buf_group: libc::__u16,
}

#[repr(C)]
pub union splice_fd_in_file_index_addr_len {
    pub splice_fd_in: libc::__s32,
    pub file_index: libc::__u32,
    pub addr_len: addr_len_padding,
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct addr_len_padding {
    pub addr_len: libc::__u16,
    pub __pad3: [libc::__u16; 1],
}

#[repr(C)]
pub union addr3_cmd {
    pub addr3: addr3_pad2,
    pub cmd: [libc::__u8; 0],
}

#[repr(C)]
#[derive(Copy, Clone)]
pub struct addr3_pad2 {
    pub addr3: libc::__u64,
    pub __pad2: [libc::__u64; 1],
}
...
pub union cmd_flags {
    ...
    pub xattr_flags: libc::__u32,
    pub msg_ring_flags: libc::__u32,
    pub uring_cmd_flags: libc::__u32,
}

#[allow(non_camel_case_types)]
type __kernel_rwf_t = libc::c_int;

pub const IORING_FILE_INDEX_ALLOC: libc::__u32 = !0;
...
pub const IORING_SETUP_IOPOLL: libc::__u32 = 1 << 0;
/// SQ poll thread.
pub const IORING_SETUP_SQPOLL: libc::__u32 = 1 << 1;
/// `sq_thread_cpu` is valid.
pub const IORING_SETUP_SQ_AFF: libc::__u32 = 1 << 2;
/// App defines CQ size.
pub const IORING_SETUP_CQSIZE: libc::__u32 = 1 << 3;
/// Clamp SQ/CQ ring sizes.
pub const IORING_SETUP_CLAMP: libc::__u32 = 1 << 4;
/// Attach to existing wq.
pub const IORING_SETUP_ATTACH_WQ: libc::__u32 = 1 << 5;
/// Start with ring disabled.
pub const IORING_SETUP_R_DISABLED: libc::__u32 = 1 << 6;
/// Continue submit on error.
pub const IORING_SETUP_SUBMIT_ALL: libc::__u32 = 1 << 7;
...
pub const IORING_SETUP_COOP_TASKRUN: libc::__u32 = 1 << 8;
/// If COOP_TASKRUN is set, get notified if task work is available for
/// running and a kernel transition would be needed to run it. This sets
/// IORING_SQ_TASKRUN in the sq ring flags. Not valid with COOP_TASKRUN.
pub const IORING_SETUP_TASKRUN_FLAG: libc::__u32 = 1 << 9;
/// SQEs are 128b.
pub const IORING_SETUP_SQE128: libc::__u32 = 1 << 10;
/// CQEs are 32b.
pub const IORING_SETUP_CQE32: libc::__u32 = 1 << 11;
/// Only one task is allowed to submit requests.
pub const IORING_SETUP_SINGLE_ISSUER: libc::__u32 = 1 << 12;
/// Defer running task work to get events.
/// Rather than running bits of task work whenever the task transitions
/// try to do it just before it is needed.
pub const IORING_SETUP_DEFER_TASKRUN: libc::__u32 = 1 << 13;
...
// sqe.cmd_flags.uring_cmd_flags
/// Use registered buffer; pass this flag along with
/// setting `sqe.buf_index`.
pub const IORING_URING_CMD_FIXED: libc::__u32 = 1 << 0;
...
pub const IORING_POLL_ADD_LEVEL: libc::__u32 = 1 << 3;
...
/// Multishot recv. Sets IORING_CQE_F_MORE if the handler will continue to report
///	CQEs on behalf of the same SQE.
pub const IORING_RECV_MULTISHOT: libc::__u32 = 1 << 1;
/// Use registered buffers, the index is stored in the buf_index field.
pub const IORING_RECVSEND_FIXED_BUF: libc::__u32 = 1 << 2;
/// If set, SEND[MSG]_ZC should report the zerocopy usage in cqe.res
/// for the IORING_CQE_F_NOTIF cqe. 0 is reported if zerocopy was actually possible.
/// IORING_NOTIF_USAGE_ZC_COPIED if data was copied (at least partially).
pub const IORING_SEND_ZC_REPORT_USAGE: libc::__u32 = 1 << 3;
...
pub const IORING_NOTIF_USAGE_ZC_COPIED: libc::__u32 = 1 << 31;

/// Accept flags stored in sqe->ioprio
pub const IORING_ACCEPT_MULTISHOT: libc::__u32 = 1 << 0;
...
pub const IORING_CQE_F_NOTIF: libc::__u32 = 1 << 3;
...
pub const IORING_ENTER_REGISTERED_RING: libc::c_uint = 1 << 4;
...
pub const IORING_RSRC_REGISTER_SPARSE: libc::__u32 = 1 << 0;
...
pub struct io_uring_recvmsg_out {
    pub namelen: libc::__u32,
    pub controllen: libc::__u32,
    pub payloadlen: libc::__u32,
    pub flags: libc::__u32,
}